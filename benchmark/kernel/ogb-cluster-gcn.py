...
def trace_handler(p):
    ...
    profile_file = profile_dir + 'profile-' + str(torch.backends.quantized.engine) + '-' + \
        'ogb' + '-' + 'cluster-gcn' + '.log'
    print(profile_file)
    with open(profile_file, 'w') as f:
        f.write(output)
        f.close()
    timeline_file = profile_dir + 'profile-' + str(torch.backends.quantized.engine) + '-' + \
        'ogb' + '-' + 'cluster-gcn' + '.json'
